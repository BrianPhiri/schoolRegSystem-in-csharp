...
namespace studentSchoolSystem_gui {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class courseDataTable : global::System.Data.TypedTableBase<courseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public courseRow AddcourseRow(int Id, int student_id, string course) {
        ...
        public partial class courseRow : global::System.Data.DataRow {
            ...
            public int student_id {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'student_id\' in table \'course\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool Isstudent_idNull() {
                return this.IsNull(this.tablecourse.student_idColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void Setstudent_idNull() {
                this[this.tablecourse.student_idColumn] = global::System.Convert.DBNull;
            }
...
namespace studentSchoolSystem_gui.DatabaseDataSetTableAdapters {
    ...
    public partial class courseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[course] WHERE (([Id] = @Original_Id) AND ((@IsNull_student_id " +
                "= 1 AND [student_id] IS NULL) OR ([student_id] = @Original_student_id)) AND ((@I" +
                "sNull_course = 1 AND [course] IS NULL) OR ([course] = @Original_course)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[course] ([Id], [student_id], [course]) VALUES (@Id, @student_i" +
                "d, @course);\r\nSELECT Id, student_id, course FROM course WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[course] SET [Id] = @Id, [student_id] = @student_id, [course] = @course WHERE (([Id] = @Original_Id) AND ((@IsNull_student_id = 1 AND [student_id] IS NULL) OR ([student_id] = @Original_student_id)) AND ((@IsNull_course = 1 AND [course] IS NULL) OR ([course] = @Original_course)));
SELECT Id, student_id, course FROM course WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, student_id, course FROM dbo.course";
        ...
        public virtual int Delete(int Original_Id, global::System.Nullable<int> Original_student_id, string Original_course) {
        ...
        public virtual int Insert(int Id, global::System.Nullable<int> student_id, string course) {
        ...
        public virtual int Update(int Id, global::System.Nullable<int> student_id, string course, int Original_Id, global::System.Nullable<int> Original_student_id, string Original_course) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> student_id, string course, int Original_Id, global::System.Nullable<int> Original_student_id, string Original_course) {
            return this.Update(Original_Id, student_id, course, Original_Id, Original_student_id, Original_course);
        }
    }
