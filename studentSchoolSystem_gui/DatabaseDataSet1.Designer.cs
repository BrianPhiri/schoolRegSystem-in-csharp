...
namespace studentSchoolSystem_gui {
    ...
    public partial class DatabaseDataSet1 : global::System.Data.DataSet {
        ...
        public partial class studentDataTable : global::System.Data.TypedTableBase<studentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public studentRow AddstudentRow(string names, System.DateTime dob, string telNo) {
        ...
        public partial class studentRow : global::System.Data.DataRow {
            ...
            public string telNo {
                get {
                    try {
                        return ((string)(this[this.tablestudent.telNoColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'telNo\' in table \'student\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IstelNoNull() {
                return this.IsNull(this.tablestudent.telNoColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SettelNoNull() {
                this[this.tablestudent.telNoColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace studentSchoolSystem_gui.DatabaseDataSet1TableAdapters {
    ...
    public partial class studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[student] WHERE (([Id] = @Original_Id) AND ((@IsNull_names = 1 AND [names] IS NULL) OR ([names] = @Original_names)) AND ((@IsNull_dob = 1 AND [dob] IS NULL) OR ([dob] = @Original_dob)) AND ((@IsNull_telNo = 1 AND [telNo] IS NULL) OR ([telNo] = @Original_telNo)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[student] ([names], [dob], [telNo]) VALUES (@names, @dob, @telN" +
                "o);\r\nSELECT Id, names, dob, telNo FROM student WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[student] SET [names] = @names, [dob] = @dob, [telNo] = @telNo WHERE (([Id] = @Original_Id) AND ((@IsNull_names = 1 AND [names] IS NULL) OR ([names] = @Original_names)) AND ((@IsNull_dob = 1 AND [dob] IS NULL) OR ([dob] = @Original_dob)) AND ((@IsNull_telNo = 1 AND [telNo] IS NULL) OR ([telNo] = @Original_telNo)));
SELECT Id, names, dob, telNo FROM student WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, names, dob, telNo FROM dbo.student";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        Id, names, dob, telNo\r\nFROM            student\r\nWHERE        (names" +
                " LIKE @name + \'%\')";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@name", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "names", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Search(DatabaseDataSet1.studentDataTable dataTable, string name) {
        ...
        public virtual int Delete(int Original_Id, string Original_names, global::System.Nullable<global::System.DateTime> Original_dob, string Original_telNo) {
        ...
        public virtual int Insert(string names, global::System.Nullable<global::System.DateTime> dob, string telNo) {
            if ((names == null)) {
        ...
        public virtual int Update(string names, global::System.Nullable<global::System.DateTime> dob, string telNo, int Original_Id, string Original_names, global::System.Nullable<global::System.DateTime> Original_dob, string Original_telNo, int Id) {
            if ((names == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string names, global::System.Nullable<global::System.DateTime> dob, string telNo, int Original_Id, string Original_names, global::System.Nullable<global::System.DateTime> Original_dob, string Original_telNo) {
            return this.Update(names, dob, telNo, Original_Id, Original_names, Original_dob, Original_telNo, Original_Id);
        }
    }
